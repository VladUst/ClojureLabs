...
(deftest integral-test-mem
  (testing "Memoization"
    (let [integral-fn1 ((calculate-integral-with-memo (fn [x] (* 2 x)) 0.01) 5)
          integral-fn2 ((calculate-integral-with-memo (fn [x] (* 2 x)) 0.01) 3)
          integral-fn3 ((calculate-integral-with-memo (fn [x] x) 0.01) 1)
          integral-fn4 ((calculate-integral-with-memo (fn [x] x) 0.01) 5)
          integral-fn5 ((calculate-integral-with-memo (fn [_] 2) 0.01) 5)]
